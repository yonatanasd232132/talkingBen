...
#define WINDOWS_BOOTMGR_PATH     C16(L"\\EFI\\Microsoft\\Boot\\bootmgfw.efi")
#define FAILED_FS_HANDLES_FMT    C16(L"Failed to get filesystem handles: %r\n")
#define FOUND_BOOTMGR_FMT        C16(L"[+] Found Windows Boot Manager at: %s\n")
