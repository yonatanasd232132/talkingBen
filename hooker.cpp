...
#define ORIGINAL_TARGET_MSG  C16(L"Original TargetFunction should not execute after hooking.\n")
#define HOOK_ATTEMPT_MSG     C16(L"Attempting to hook TargetFunction...\n")
